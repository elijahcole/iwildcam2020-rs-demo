...
plt.figure()
plt.imshow(I_pixelqa_parsed[:,:,rs.pixelqa_idx['cloud']],vmin=0,vmax=1)
plt.colorbar()
plt.title('Pixels Classified as "Cloud"')
plt.savefig('I_pixelqa_cloud.png')
plt.close()

plt.figure()
plt.imshow(I_pixelqa_parsed[:,:,rs.pixelqa_idx['cloud_shadow']],vmin=0,vmax=1)
plt.colorbar()
plt.title('Pixels Classified as "Shadow"')
plt.savefig('I_pixelqa_shadow.png')
plt.close()
